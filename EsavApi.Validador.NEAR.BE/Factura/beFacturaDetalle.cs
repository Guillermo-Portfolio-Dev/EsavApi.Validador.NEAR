...
namespace EsavApi.Validador.NEAR.BE.Factura
{
    public class beFacturaDetalle
    {
        ...
        public beFacturaDetalleTransporteCarga TransporteCarga { get; set; }
        public List<beFacturaDeliveryDetalle> listaPropiedad { get; set; }
        //public List<CampoAdicionalRegistroDetalle> lCampoAdicional { get; set; }
